    ...
    public partial class AddGroupUser : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ApplicationGruops", t => t.GroupId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationUserGroups", "GroupId", "dbo.ApplicationGruops");
            DropForeignKey("dbo.ApplicationRoleGroups", "RoleId", "dbo.ApplicationRoles");
            DropForeignKey("dbo.ApplicationRoleGroups", "GroupId", "dbo.ApplicationGruops");
            ...
            DropTable("dbo.ApplicationGruops");
        }
    }
}
